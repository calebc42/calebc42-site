+++
title = "Kanban Card Implementation: Why I Chose Index Cards Over Software"
author = ["desktop"]
date = 2018-08-01
layout = "list"
lastmod = 2026-01-19T16:19:02-07:00
tags = ["operations", "kanban", "kaizen", "internship", "supply-chain"]
categories = ["Portfolio"]
draft = false
technologies = ["Excel", "Infor ERP VISUAL"]
skills = ["Kanban System Design", "Process Optimization", "Lean Manufacturing Principles", "Root Cause Analysis (5-Why)", "CAPA (Corrective Action)", "Data-Driven Decision Making", "Change Management", "Stakeholder Management", "KPI Reporting"]
+++
